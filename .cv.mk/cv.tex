...
\begin{itemize}
	\item MorrisCooke, 2012, {\bf iOS developer}
		\begin{itemize}
			\item StickAround
		\end{itemize}

%	\item Timepie, 2012, {\bf OS X developer} 1 month
%		Activity tracking app - AppleScript to talk with browsers, OAuth - OS X app
